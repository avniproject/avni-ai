...
def parse_function_arguments(arguments_str: str, call_id: str) -> Optional[Dict[str, Any]]:
...
def format_tools_for_continuation(
    ...
    """
    formatted_tools = []
    tools_to_use = available_tools if available_tools else tool_registry.get_openai_tools()
