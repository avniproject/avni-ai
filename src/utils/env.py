...
AVNI_CLIENT_TIMEOUT_SECONDS = float(os.getenv("AVNI_CLIENT_TIMEOUT_SECONDS", "60.0"))
ENTITY_STORE_TTL_HOURS = int(os.getenv("ENTITY_STORE_TTL_HOURS", "6"))
BUNDLE_STORE_TTL_HOURS = int(os.getenv("BUNDLE_STORE_TTL_HOURS", "6"))
SPEC_STORE_TTL_HOURS = int(os.getenv("SPEC_STORE_TTL_HOURS", "6"))
MAX_SPEC_RESPONSE_CHARS = int(os.getenv("MAX_SPEC_RESPONSE_CHARS", "8000"))
