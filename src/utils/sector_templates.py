...
_SECTOR_FORM_FIELDS: dict[str, dict[str, list[dict[str, Any]]]] = {
    "MCH": {
        ...
        "PNC": [
            ...
            {"name": "Temperature", "dataType": "Numeric", "unit": "F", "mandatory": True},
            {"name": "BP Systolic", "dataType": "Numeric", "unit": "mmHg", "mandatory": True},
            {"name": "BP Diastolic", "dataType": "Numeric", "unit": "mmHg", "mandatory": True},
            {
        ...
        "HBNC": [
            {"name": "Baby Weight", "dataType": "Numeric", "unit": "kg", "mandatory": True},
            {"name": "Temperature", "dataType": "Numeric", "unit": "F", "mandatory": True},
            {
                "name": "Breastfeeding Status",
                "dataType": "Coded",
        ...
        "Immunization": [
            ...
            {"name": "Vaccination Date", "dataType": "Date", "mandatory": True},
            {
                ...
                "dataType": "Coded",
                "options": ["None", "Mild Fever", "Swelling", "Rash", "Severe Reaction"],
                "mandatory": False,
            },
        ],
        "Growth Monitoring": [
    ...
    "Nutrition": {
        "Nutrition Assessment": [
            ...
            {"name": "Hemoglobin", "dataType": "Numeric", "unit": "g/dL", "mandatory": False},
        ],
        "Counselling": [
            {
    ...
    "Livelihoods": {
        "Skill Assessment": [
            {
                ...
                "dataType": "Coded",
                "options": ["No Formal Education", "Primary", "Secondary", "Higher Secondary", "Graduate", "Post Graduate"],
                "mandatory": True,
            },
            {
                "name": "Current Occupation",
                "dataType": "Coded",
                "options": ["Agriculture", "Daily Wage", "Self Employed", "Unemployed", "Student", "Other"],
                "mandatory": True,
            },
            {
                "name": "Skill Area",
                "dataType": "Coded",
                "options": ["Tailoring", "Computer", "Driving", "Electrical", "Plumbing", "Beautician", "Other"],
                "mandatory": True,
            },
            {"name": "Monthly Income", "dataType": "Numeric", "unit": "INR", "mandatory": False},
        ],
        "Training": [
        ...
        "SHG Meeting": [
            ...
            {"name": "Savings Collected", "dataType": "Numeric", "unit": "INR", "mandatory": False},
            {"name": "Loans Disbursed", "dataType": "Numeric", "unit": "INR", "mandatory": False},
            {"name": "Notes", "dataType": "Text", "mandatory": False},
        ],
    },
    "Education": {
        ...
        "Attendance Tracking": [
            ...
            {"name": "Days Absent", "dataType": "Numeric", "mandatory": True},
            {
                ...
                "dataType": "Coded",
                "options": ["Illness", "Family Work", "Migration", "Lack of Interest", "Other"],
                "mandatory": False,
            },
        ],
        "Learning Assessment": [
            {
                "name": "Reading Level",
                "dataType": "Coded",
                "options": ["Cannot Read", "Letters", "Words", "Sentences", "Paragraph", "Story"],
                "mandatory": True,
            },
            {
                "name": "Math Level",
                "dataType": "Coded",
                "options": ["Cannot Recognise Numbers", "Numbers 1-9", "Numbers 10-99", "Subtraction", "Division"],
                "mandatory": True,
            },
        ...
        "Household Survey": [
            {
                "name": "Water Source",
                "dataType": "Coded",
                "options": ["Piped", "Hand Pump", "Well", "River/Pond", "Tanker", "Other"],
                "mandatory": True,
            },
            {
                "name": "Toilet Type",
