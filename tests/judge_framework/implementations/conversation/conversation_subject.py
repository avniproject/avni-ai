...
class ConversationTestSubject(TestSubject):
    ...
    def get_expected_behavior(self) -> str:
        ...
        return self.expected_behavior or f"AI assistant should handle {self.scenario_name} scenario correctly"
...
"""
    ...
    def create_static_test_cases(self) -> List[Dict[str, Any]]:
        ...
        static_cases = []
        for i, (prompt, name) in enumerate(zip(self.scenario_prompts, self.scenario_names)):
