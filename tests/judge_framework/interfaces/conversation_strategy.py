...
class ConversationGenerationStrategy(ABC):
    ...
    @abstractmethod
    def generate_next_message(self, conversation_history: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
        """
    ...
    @abstractmethod
    def should_continue_conversation(self, conversation_history: List[Dict[str, Any]], context: Dict[str, Any]) -> bool:
        """
...
class AIConversationStrategy(ConversationGenerationStrategy):
    ...
    def __init__(self, scenario_prompts: List[str], openai_model: str = "gpt-4o", temperature: float = 0.5):
    ...
    def _convert_to_tester_perspective(self, conversation_history: List[Dict[str, Any]]) -> List[Dict[str, str]]:
        """
