---
title: Frequently Asked Questions - Implementation
category: reference
...
retrieval_boost: 1.5
related_topics:
- ../00-getting-started/quick-start-implementer.md
estimated_reading_time: 64 minutes
version: '1.0'
---
...
<!-- CHUNK: can-i-do-regex-validations-in-avni -->
...
<!-- CHUNK: can-i-make-a-form-available-only-to-specific-user- -->
...
<!-- CHUNK: how-do-i-make-a-question-appear-only-if-another-an -->
...
<!-- CHUNK: can-avni-support-multi-language-forms -->
...
<!-- CHUNK: how-do-i-mark-a-field-as-mandatory -->
...
<!-- CHUNK: can-i-attach-media-photos-audio-to-a-form-in-avni -->
...
<!-- CHUNK: how-do-i-configure-a-follow-up-encounter -->
...
<!-- CHUNK: can-i-edit-a-form-after-it-has-been-deployed -->
...
<!-- CHUNK: how-do-i-duplicate-an-existing-form-configuration -->
...
<!-- CHUNK: can-i-limit-form-access-based-on-user-roles -->
...
<!-- CHUNK: what-s-the-difference-between-subject-program-and- -->
...
<!-- CHUNK: how-do-i-design-a-workflow-for-maternal-health-tra -->
...
<!-- CHUNK: how-can-i-model-household-individual-relationships -->
...
<!-- CHUNK: how-do-i-track-recurring-visits-for-a-subject -->
...
<!-- CHUNK: how-do-i-set-up-a-longitudinal-data-collection-wor -->
...
<!-- CHUNK: what-s-the-best-way-to-handle-referrals-between-wo -->
...
<!-- CHUNK: how-can-i-manage-cases-that-get-closed-and-reopene -->
...
<!-- CHUNK: how-do-i-configure-a-multi-step-service-delivery-w -->
...
<!-- CHUNK: can-i-link-a-child-record-to-a-household-subject -->
...
<!-- CHUNK: how-do-i-manage-subjects-across-multiple-programs -->
...
<!-- CHUNK: how-can-i-model-seasonal-data-collection-e-g-crops -->
...
<!-- CHUNK: how-do-i-configure-a-one-time-survey-vs-ongoing-ca -->
...
<!-- CHUNK: how-do-i-manage-data-across-multiple-locations -->
...
<!-- CHUNK: can-i-assign-subjects-to-specific-users-or-teams -->
...
<!-- CHUNK: how-do-i-record-both-baseline-and-follow-up-data -->
...
<!-- CHUNK: what-s-the-best-way-to-model-school-student-tracki -->
...
<!-- CHUNK: how-do-i-manage-multiple-identifiers-for-the-same- -->
...
<!-- CHUNK: how-can-i-record-gps-location-data-with-each-encou -->
...
<!-- CHUNK: how-do-i-set-up-case-closure-criteria -->
...
<!-- CHUNK: can-i-link-data-from-one-form-into-another -->
...
<!-- CHUNK: how-do-i-write-a-rule-to-calculate-bmi-in-avni -->
...
<!-- CHUNK: can-i-prevent-form-submission-if-a-rule-fails -->
...
<!-- CHUNK: how-do-i-create-a-rule-to-send-an-alert-for-high-b -->
...
<!-- CHUNK: how-do-i-check-if-a-subject-is-under-5-years-old-i -->
...
<!-- CHUNK: how-do-i-create-a-rule-for-conditional-program-enr -->
...
<!-- CHUNK: can-i-use-javascript-libraries-inside-avni-rules -->
...
<!-- CHUNK: how-do-i-write-a-rule-to-auto-populate-a-field -->
...
<!-- CHUNK: how-do-i-validate-a-phone-number-with-a-regex-rule -->
...
<!-- CHUNK: how-do-i-enforce-that-visits-happen-within-30-days -->
...
<!-- CHUNK: can-i-access-previous-encounter-data-in-a-rule -->
...
<!-- CHUNK: how-do-i-create-a-rule-that-prevents-duplicate-reg -->
...
<!-- CHUNK: how-can-i-trigger-a-follow-up-form-automatically -->
...
<!-- CHUNK: can-i-write-a-rule-to-calculate-gestational-age -->
...
<!-- CHUNK: how-do-i-enforce-minimum-and-maximum-age-limits -->
...
<!-- CHUNK: how-do-i-use-rules-for-referral-workflows -->
...
<!-- CHUNK: how-do-i-debug-a-failing-rule-in-avni -->
...
<!-- CHUNK: can-i-export-all-my-rules-for-review -->
...
<!-- CHUNK: can-i-use-avni-offline-for-a-whole-week -->
...
<!-- CHUNK: how-do-i-change-the-app-language -->
...
<!-- CHUNK: how-do-i-search-for-a-subject-in-the-field-app -->
...
<!-- CHUNK: what-happens-if-i-accidentally-delete-a-record -->
...
<!-- CHUNK: how-do-i-know-if-my-data-is-synced -->
...
<!-- CHUNK: can-i-see-my-past-encounters-for-a-subject -->
...
<!-- CHUNK: how-do-i-mark-a-subject-as-inactive -->
## How do I mark a subject as inactive?

You can simply void the subject
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-transfer-a-subject-to-another-worker -->
...
<!-- CHUNK: can-i-generate-pdf-reports-from-avni -->
## Can I generate PDF reports from Avni?

added to git
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-get-aggregated-data-by-location -->
## How do I get aggregated data by location?

added to git
<!-- END CHUNK -->

<!-- CHUNK: can-i-query-avni-directly-with-sql -->
## Can I query Avni directly with SQL?

added to git
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-filter-data-exports-by-date -->
## How do I filter data exports by date?

added to git
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-schedule-custom-reports -->
## How do I schedule custom reports?

added to git
<!-- END CHUNK -->

<!-- CHUNK: what-is-the-structure-of-avni-s-database -->
## What is the structure of Avni’s database?

added to git
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-create-a-dropdown-field-with-predefined-o -->
...
<!-- CHUNK: how-do-i-migrate-data-from-another-system-into-avn -->
...
<!-- CHUNK: can-i-integrate-avni-with-sms-or-whatsapp-alerts -->
...
<!-- CHUNK: how-do-i-monitor-api-usage-and-limits -->
...
<!-- CHUNK: answer-yes-we-can-configure-cascading-drop-downs-o -->
...
<!-- CHUNK: how-do-i-copy-a-question-from-one-form-to-another -->
...
<!-- CHUNK: can-i-hide-a-field-from-data-collectors-but-keep-i -->
...
<!-- CHUNK: how-do-i-configure-default-language-for-a-form -->
...
<!-- CHUNK: can-i-restrict-date-fields-to-future-dates-only -->
...
<!-- CHUNK: how-do-i-enable-gps-capture-in-registration-forms -->
...
<!-- CHUNK: can-i-create-a-calculated-field-based-on-two-numer -->
...
<!-- CHUNK: how-do-i-make-a-field-appear-only-during-new-subje -->
...
<!-- CHUNK: how-can-i-reorder-questions-in-a-form -->
...
<!-- CHUNK: can-i-create-a-checkbox-list-where-multiple-option -->
...
<!-- CHUNK: can-i-make-a-field-read-only-after-first-entry -->
...
<!-- CHUNK: how-do-i-enforce-that-one-field-must-be-filled-if- -->
...
<!-- CHUNK: how-can-i-store-multiple-phone-numbers -->
...
<!-- CHUNK: can-i-use-qr-codes-for-subject-ids-in-avni -->
## Can I use QR codes for subject IDs in Avni?

No, not currently
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-configure-automatic-case-closure-after-6- -->
...
<!-- CHUNK: can-i-configure-a-form-to-appear-only-once-per-pro -->
...
<!-- CHUNK: how-do-i-make-a-yes-no-field-mandatory -->
...
<!-- CHUNK: can-i-pre-fill-information-from-previous-visits -->
...
<!-- CHUNK: how-do-i-add-an-image-upload-field -->
...
<!-- CHUNK: can-i-create-dynamic-labels-based-on-other-field-v -->
...
<!-- CHUNK: how-do-i-enable-conditional-skip-logic-across-sect -->
...
<!-- CHUNK: can-i-configure-reminders-for-upcoming-encounters -->
...
<!-- CHUNK: how-do-i-configure-a-repeatable-group-of-fields -->
...
<!-- CHUNK: can-i-set-a-numeric-field-to-allow-decimals-only -->
...
<!-- CHUNK: how-do-i-configure-a-program-where-only-supervisor -->
...
<!-- CHUNK: can-i-create-a-read-only-dashboard-for-workers-in- -->
...
<!-- CHUNK: how-do-i-configure-a-field-that-stores-household-g -->
...
<!-- CHUNK: can-i-configure-gender-specific-forms-in-avni -->
## Can I configure gender-specific forms in Avni?

Yes we can do my adding the rule in the form
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-set-default-answers-for-checkboxes -->
...
<!-- CHUNK: how-do-i-configure-case-assignment-based-on-locati -->
...
<!-- CHUNK: how-do-i-model-a-program-for-chronic-disease-manag -->
...
<!-- CHUNK: can-i-design-workflows-for-both-subjects-and-facil -->
...
<!-- CHUNK: how-do-i-create-a-workflow-for-nutrition-tracking -->
...
<!-- CHUNK: can-i-model-relationships-like-teacher-student-gua -->
...
<!-- CHUNK: can-i-assign-a-subject-to-multiple-programs-at-onc -->
## Can I assign a subject to multiple programs at once?

Yes, a subject can be enrolled in multiple programs at a time
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-create-a-workflow-for-tracking-immunizati -->
...
<!-- CHUNK: can-i-design-a-program-that-ends-after-a-specific- -->
...
<!-- CHUNK: can-i-track-household-level-interventions-as-well- -->
...
<!-- CHUNK: how-do-i-configure-seasonal-visits-e-g-annual-surv -->
...
<!-- CHUNK: can-i-track-dropout-cases-and-reasons -->
...
<!-- CHUNK: can-i-design-workflows-that-include-supervisor-app -->
...
<!-- CHUNK: how-do-i-configure-different-visit-schedules-for-c -->
...
<!-- CHUNK: how-can-i-model-data-for-disaster-relief-beneficia -->
...
<!-- CHUNK: can-i-set-up-workflows-that-branch-based-on-eligib -->
...
<!-- CHUNK: how-do-i-manage-subjects-who-belong-to-multiple-ho -->
...
<!-- CHUNK: can-i-configure-avni-to-track-both-individuals-and -->
...
<!-- CHUNK: can-i-create-a-single-program-with-multiple-enroll -->
...
<!-- CHUNK: how-do-i-configure-workflows-for-child-growth-moni -->
...
<!-- CHUNK: can-i-model-a-workflow-where-visits-reduce-over-ti -->
...
<!-- CHUNK: how-do-i-check-if-my-app-has-the-latest-forms -->
...
<!-- CHUNK: can-i-work-in-two-different-programs-at-the-same-t -->
...
<!-- CHUNK: how-do-i-find-all-subjects-assigned-to-me -->
...
<!-- CHUNK: can-i-register-a-new-subject-without-network -->
...
<!-- CHUNK: how-do-i-sync-partially-completed-forms -->
...
<!-- CHUNK: what-happens-if-two-users-register-the-same-subjec -->
...
<!-- CHUNK: how-do-i-mark-a-subject-as-deceased -->
...
<!-- CHUNK: can-i-view-my-assigned-workload-for-the-week -->
...
<!-- CHUNK: how-do-i-reset-my-password-in-the-field-app -->
## How do I reset my password in the field app?

After login >> home dashboard>> More >> Change password
<!-- END CHUNK -->

<!-- CHUNK: how-do-i-identify-subjects-with-overdue-visits -->
...
<!-- CHUNK: can-i-search-for-subjects-by-multiple-fields-name- -->
...
<!-- CHUNK: how-do-i-report-an-error-from-the-field-app -->
...
<!-- CHUNK: can-i-update-my-app-without-losing-offline-data -->
...
<!-- CHUNK: how-do-i-check-which-data-has-not-yet-synced -->
...
<!-- CHUNK: can-i-pause-form-filling-and-return-later -->
...
<!-- CHUNK: how-do-i-use-avni-with-multiple-languages-at-once -->
...
<!-- CHUNK: can-i-hide-sensitive-information-from-field-worker -->
...
<!-- CHUNK: how-do-i-ensure-gps-accuracy-during-data-collectio -->
...
<!-- CHUNK: can-i-undo-the-last-change-in-a-filled-form -->
...
<!-- CHUNK: when-i-sign-in-to-avni-it-says-catchment-not-set-u -->
...
<!-- CHUNK: is-my-data-stored-encrypted-on-the-phone -->
...
<!-- CHUNK: i-signed-out-from-avni-and-am-now-at-the-field-the -->
...
<!-- CHUNK: what-is-the-difference-between-self-service-assist -->
...
<!-- CHUNK: can-i-add-multiple-languages-to-the-app -->
...
<!-- CHUNK: will-i-get-data-collected-on-real-time-basis-to-vi -->
...
<!-- CHUNK: is-avni-free-of-cost-if-not-what-are-charges -->
